...
- **Temporal KB tier (opt-in fact-tier on top of the page-tier wiki):** [docs/temporal-kb.md](docs/temporal-kb.md) — spec at [temporal_markdown_knowledge_base_spec.md](temporal_markdown_knowledge_base_spec.md), implementation plan at [temporal_kb_implementation_plan.md](temporal_kb_implementation_plan.md)
